...
export async function DashboardShell({
  ...
  return (
    <div className="flex min-h-screen bg-background">
      {/* Sidebar */}
      <aside className="w-[260px] shrink-0 bg-card border-r border-border flex flex-col">
        {/* Logo */}
        <div className="px-6 pt-6 pb-5">
          <Link href="/dashboard" className="block">
            <span className="text-[10px] font-semibold text-muted-foreground/60 uppercase tracking-widest block mb-0.5">
              The Digital Curator
            </span>
            <span className="font-display text-[17px] font-bold text-foreground tracking-tight">
              Spiel<span className="text-primary">Vault</span>
            </span>
          </Link>
        </div>
